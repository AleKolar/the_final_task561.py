...
'''
Здравствуйте! Это практическое задание, прям откровение!
Это как психоанализ, трудно принять правду о себе, что Ты - гений на минималках!
...
def player_choice(
        board):  # ф-ия осуществляет выбор клетки игроком и затем(в реализации) ф-ия boardplace_of_marker помещает символ в клетку
    position = 0
